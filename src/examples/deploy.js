...
// Call deploy_compiled_contract endpoint using Delegated Deployment Service
// The server will deploy the contract using its own funded wallet
// Client pays 0.05 USDC to cover gas costs + service fee
console.log("\n🚀 Deploying contract using Delegated Deployment Service...");
